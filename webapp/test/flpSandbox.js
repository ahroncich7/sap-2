		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "dest2",
									"targetURL": "#destinationtestdestination2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"destinationtestdestination2-display": {
								"semanticObject": "destinationtestdestination2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=destinationtest.destination2",
									"url": sap.ui.require.toUrl("destinationtest/destination2")
								}
							}
						}
					}
